...
1. Download the [latest version](https://github.com/utags/utags-advanced-filter/releases) or one of the [releases](https://github.com/utags/utags-advanced-filter/releases)
